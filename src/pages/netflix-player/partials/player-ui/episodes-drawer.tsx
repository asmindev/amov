...
export function EpisodesDrawer({
  ...
  return (
    ...
    >
      <div className="pointer-events-auto flex w-full flex-col border-t border-white/15 bg-linear-to-t from-black via-black/20 to-black/20 p-4 text-white shadow-2xl backdrop-blur-xl md:px-8 md:pt-5 md:pb-20">
        {/* Header */}
        ...
        {isPending ? (
          ...
          <div className="relative">
            ...
            <div
              ref={carouselRef}
              className="flex scrollbar-thin scrollbar-thumb-white/20 flex-row gap-4 overflow-x-auto py-2 pr-12 pl-12"
            >
